...
namespace SchedulerArmSDKTemplate
{
    class Program
    {
        ...
        {
            String serviceBusSasKey = "tvFviHvCrxOYWOSU5FgoJpfUz/UOqOFAVdFUmTUkCWg=";
            String sasKeyName = "RootManageSharedAccessKey";
            String queueName = "dlm";
            ServiceBusAuthenticationType type = ServiceBusAuthenticationType.SharedAccessKey;
            ServiceBusAuthentication authentication = new ServiceBusAuthentication(serviceBusSasKey, sasKeyName, type);
